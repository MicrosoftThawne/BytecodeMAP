...
/*
	[!] Scanning
	[!] Used for scanning the ScriptContext Value from process injected into, only will work for 'RobloxPlayerBeta.exe' if you don't edit the Address and Scanning.
*/
